...
\definecolor{light-green}{RGB}{200,255,167}
\definecolor{light-yellow}{RGB}{255,238,60}
\definecolor{light-ping}{RGB}{251,200,200}
...
\newcommand{\Exercises}[1]{\refstepcounter{exercises}
	...
	{\Large\textbf{#1}}\addcontentsline{toc}{section}{\textit{Упражнение\,\arabic{exercises}}\quad#1}
	\vspace{1ex}~\\
}
